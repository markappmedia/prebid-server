...
require (
	github.com/51Degrees/device-detection-go/v4 v4.5.10
	github.com/DATA-DOG/go-sqlmock v1.5.2
	github.com/IABTechLab/adscert v0.51.0
	github.com/NYTimes/gziphandler v1.1.1
	github.com/WURFL/golang-wurfl v1.33.0
...
require (
	...
	github.com/51Degrees/common-go/v4 v4.5.0 // indirect
